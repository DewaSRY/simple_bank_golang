...
// Source: github.com/DewaSRY/core-service/internal/db/sqlc (interfaces: Querier)
//
// Generated by this command:
//
//	mockgen -package mockdb -destination internal/db/mock/querier.go github.com/DewaSRY/core-service/internal/db/sqlc Querier
//
...
func (m *MockQuerier) CountAccountsSearchByUserNumber(ctx context.Context, number sql.NullString) (int64, error) {
	m.ctrl.T.Helper()
...
func (mr *MockQuerierMockRecorder) CountAccountsSearchByUserNumber(ctx, number any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CountAccountsSearchByUserNumber", reflect.TypeOf((*MockQuerier)(nil).CountAccountsSearchByUserNumber), ctx, number)
}
...
func (m *MockQuerier) GetAccountViewById(ctx context.Context, id int64) (db.GetAccountViewByIdRow, error) {
	m.ctrl.T.Helper()
...
func (mr *MockQuerierMockRecorder) GetAccountViewById(ctx, id any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetAccountViewById", reflect.TypeOf((*MockQuerier)(nil).GetAccountViewById), ctx, id)
}
...
func (mr *MockQuerierMockRecorder) ListAccountEntriesByAccountId(ctx, arg any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListAccountEntriesByAccountId", reflect.TypeOf((*MockQuerier)(nil).ListAccountEntriesByAccountId), ctx, arg)
}
